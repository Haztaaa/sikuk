...
!(function (e, n) {
	...
	((t.configure = function (e) {
		...
		(t.set = function (e) {
			var n = t.isStarted();
			((e = i(e, r.minimum, 1)), (t.status = 1 === e ? null : e));
			var u = t.render(!n),
								...
								i =
									"translate3d" === r.positionUsing
										...
										: "translate" === r.positionUsing
											...
											: { "margin-left": s(e) + "%" };
								return ((i.transition = "all " + n + "ms " + t), i);
							})(e, l, f),
						),
						1 === e
		...
		(t.render = function (e) {
			...
			var i,
				o = n.querySelector(r.barSelector),
				u = e ? "-100" : s(t.status || 0),
			...
			return (
				...
				r.showSpinner || ((i = n.querySelector(r.spinnerSelector)) && d(i)),
	...
	var o = (function () {
		...
		a = (function () {
				...
				return (
					...
					n[t] ||
						(n[t] = (function (n) {
							...
							if (n in t) return n;
							for (
								var r, i = e.length, s = n.charAt(0).toUpperCase() + n.slice(1);
								i--;
							)
								if ((r = e[i] + s) in t) return r;
							return n;
						})(t))
				);
			}
			...
			return function (e, n) {
				...
				if (2 == s.length)
					for (t in n)
						void 0 !== (i = n[t]) && n.hasOwnProperty(t) && r(e, t, i);
				else r(e, s[1], s[2]);
			};
		})();
	function u(e, n) {
	...
	function c(e, n) {
		var t = f(e),
			r = t + n;
		u(t, n) || (e.className = r.substring(1));
	}
	function l(e, n) {
		var t,
			r = f(e);
