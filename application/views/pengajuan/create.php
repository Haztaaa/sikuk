                    ...
                    <div class="card mb-3">
                        <div class="card-body pt-4">
                            <h6 class="card-title d-flex align-items-center gap-2 mb-3">
                                <span class="badge bg-primary rounded-circle d-flex align-items-center justify-content-center text-white"
                    ...
                    <div class="card mb-3" id="sectionLampiran" style="display:none;">
                        <div class="card-body pt-4">
                            <h6 class="card-title d-flex align-items-center gap-2 mb-1">
                                <span class="badge bg-warning text-dark rounded-circle d-flex align-items-center justify-content-center text-white"
